  ...
  export const Form=({handleClose,isEditing,product})=> {
      ...
      const inputFormHandler = (e) => {
        ...
        //   const imageData = reader.result;
          ...
          const newProduct = {
            id: inputId,
            title: inputValue,
            image: isEditing ? product.image : image[0],
            size: size,
      ...
      useEffect(() => {
        // Populate the input fields with product details when editing
            ...
            <Fragment>
              <div>
                <table className="cover">
                 ...
                 { !isEditing && (
                 <Fragment><label htmlFor="price" Data-testid='productImage'>UPLOAD IMAGE</label>
                  <input
