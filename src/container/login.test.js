...
describe("Component Tests", function () {
  test('length of the entered text',()=>{
    storeRender();
    fireEvent.change(screen.getByTitle('login-mailID'), { target: { value: '' } });
    expect(screen.getByTitle('login-mailID').value.length).toBe(0)
